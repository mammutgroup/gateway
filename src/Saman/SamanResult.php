...
class SamanResult
{
    ...
    private static $results = array(
        array(
            'code' => SamanResult::ERROR_CONNECT,
            'message' => SamanResult::ERROR_CONNECT_MESSAGE,
            'fa' => 'خطا در اتصال به درگاه سداد',
            'en' => 'Error in connect to sadad',
            'retry' => false
        ),
        array(
            'code' => SamanResult::INVALID_RESPONSE_CODE,
            'message' => SamanResult::INVALID_RESPONSE_MESSAGE,
            'fa' => 'جواب نامعتبر',
            'en' => 'Invalid Response',
            'retry' => false
        ),
